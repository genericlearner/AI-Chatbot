  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Container maxWidth="xs">
        <Paper elevation={3} sx={{ padding: 4, borderRadius: 2, backgroundColor: theme.palette.background.default }}>
          <Box
            display="flex"
          ...
          >
            ...
            <Box component="form" onSubmit={handleSignUp} noValidate sx={{ mt: 1 }}>
              ...
              <Button
                ...
                variant="contained"
                color="secondary"
                sx={{ mt: 3, mb: 2, borderRadius: '20px', backgroundColor: '#004d40', textTransform: 'none' }}
              >
                Sign Up
              </Button>
              ...
              <Button
                ...
                variant="contained"
                color="secondary"
                sx={{ mt: 2, mb: 2, borderRadius: '20px', backgroundColor: '#004d40', color: '#ffffff', textTransform: 'none' }}
